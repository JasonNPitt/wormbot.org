...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['cache.driver'] = new \phpbb\cache\driver\file('/var/www/html/forum/install/../cache/installer/');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, '/var/www/html/forum/install/../', $this->get('template'));
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator($this->get('filesystem'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.file_updater.compress'] = new \phpbb\install\helper\file_updater\compression_file_updater($this->get('installer.helper.update_helper'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.file_updater.file'] = new \phpbb\install\helper\file_updater\file_updater($this->get('filesystem'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.file_updater.ftp'] = new \phpbb\install\helper\file_updater\ftp_file_updater($this->get('installer.helper.update_helper'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.helper.config'] = new \phpbb\install\helper\config($this->get('filesystem'), $this->get('php_ini'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.helper.container_factory'] = new \phpbb\install\helper\container_factory($this->get('language'), $this->get('request'), $this->get('installer.helper.update_helper'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.helper.database'] = new \phpbb\install\helper\database($this->get('filesystem'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.helper.install_helper'] = new \phpbb\install\helper\install_helper('/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        $this->services['installer.helper.iohandler_ajax'] = $instance = new \phpbb\install\helper\iohandler\ajax_iohandler($this->get('path_helper'), $this->get('request'), $this->get('template'), $this->get('router'), '/var/www/html/forum/install/../');
    ...
    {
        return $this->services['installer.helper.update_helper'] = new \phpbb\install\helper\update_helper('/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.install_data.add_bots'] = new \phpbb\install\module\install_data\task\add_bots($this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.container_factory'), $this->get('language'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.install_database.add_tables'] = new \phpbb\install\module\install_database\task\add_tables($this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('filesystem'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.install_database.create_schema_file'] = new \phpbb\install\module\install_database\task\create_schema_file($this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('filesystem'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.install_database.set_up_database'] = new \phpbb\install\module\install_database\task\set_up_database($this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('filesystem'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.install_filesystem.create_config_file'] = new \phpbb\install\module\install_filesystem\task\create_config_file($this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.database'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../', 'php', array());
    }
    ...
    {
        return $this->services['installer.install_finish.install_extensions'] = new \phpbb\install\module\install_finish\task\install_extensions($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.install_finish.notify_user'] = new \phpbb\install\module\install_finish\task\notify_user($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.obtain_data.update_files'] = new \phpbb\install\module\obtain_data\task\obtain_update_files($this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.requirements.check_filesystem'] = new \phpbb\install\module\requirements\task\check_filesystem($this->get('filesystem'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.requirements.check_filesystem_update'] = new \phpbb\install\module\requirements\task\check_filesystem($this->get('filesystem'), $this->get('installer.helper.iohandler'), '/var/www/html/forum/install/../', 'php', false);
    }
    ...
    {
        return $this->services['installer.requirements.update_requirements'] = new \phpbb\install\module\requirements\task\check_update($this->get('installer.helper.container_factory'), $this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.update_helper'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['installer.update_database.update_task'] = new \phpbb\install\module\update_database\task\update($this->get('installer.helper.container_factory'), $this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('language'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.update_filesystem.check_task'] = new \phpbb\install\module\update_filesystem\task\file_check($this->get('filesystem'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.helper.update_helper'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['installer.update_filesystem.update_files'] = new \phpbb\install\module\update_filesystem\task\update_files($this->get('installer.helper.container_factory'), $this->get('installer.helper.config'), $this->get('installer.helper.iohandler'), $this->get('installer.file_updater.factory'), $this->get('installer.helper.update_helper'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['language.helper.language_file'] = new \phpbb\language\language_file_helper('/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['language.loader'] = new \phpbb\language\language_file_loader('/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.convert'] = new \phpbb\convert\controller\convertor($this->get('cache.driver'), $this->get('installer.helper.container_factory'), $this->get('installer.helper.database'), $this->get('phpbb.installer.controller.helper'), $this->get('installer.helper.install_helper'), $this->get('installer.helper.iohandler_factory'), $this->get('language'), $this->get('installer.navigation.provider'), $this->get('request'), $this->get('template'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.helper'] = new \phpbb\install\controller\helper($this->get('installer.helper.config'), $this->get('language'), $this->get('language.helper.language_file'), $this->get('installer.navigation.provider'), $this->get('template'), $this->get('path_helper'), $this->get('request'), $this->get('symfony_request'), $this->get('router'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.status'] = new \phpbb\install\controller\timeout_check($this->get('phpbb.installer.controller.helper'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['phpbb.installer.controller.welcome'] = new \phpbb\install\controller\installer_index($this->get('phpbb.installer.controller.helper'), $this->get('language'), $this->get('template'), '/var/www/html/forum/install/../');
    }
    ...
    {
        return $this->services['router'] = new \phpbb\routing\router($this, $this->get('routing.chained_resources_locator'), $this->get('routing.delegated_loader'), 'php', '/var/www/html/forum/install/../cache/installer/');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper($this->get('config'), $this->get('router'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), '/var/www/html/forum/install/../', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\installer_resources_locator($this->get('filesystem'), '/var/www/html/forum/install/../', 'installer');
    }
    ...
    {
        return $this->services['template'] = new \phpbb\template\twig\twig($this->get('path_helper'), $this->get('config'), $this->get('template_context'), $this->get('template.twig.environment'), '/var/www/html/forum/install/../cache/installer/twig/', NULL, $this->get('template.twig.extensions.collection'));
    }
    ...
    {
        $this->services['template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), '/var/www/html/forum/install/../cache/installer/twig/', NULL, $this->get('template.twig.loader'), array());
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006c92b6a20000000026488bdf(
    ...
    {
        return array(
            'core.root_path' => '/var/www/html/forum/install/../',
            'core.php_ext' => 'php',
            'core.environment' => 'installer',
            'core.debug' => false,
            'core.cache_dir' => '/var/www/html/forum/install/../cache/installer/',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'core.template.cache_path' => '/var/www/html/forum/install/../cache/installer/twig/',
...
class phpbbtemplatetwiglexer_000000006c92b6a20000000026488bdf extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a9f3f1bece4a315313745 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a9f3f1bece4e405620412 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a9f3f1bece3b267752283 = array(
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, 'set_environment', array('env' => $env), $this->initializer5a9f3f1bece4e405620412);

        return $this->valueHolder5a9f3f1bece4a315313745->set_environment($env);
    }
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a9f3f1bece4e405620412);

        return $this->valueHolder5a9f3f1bece4a315313745->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a9f3f1bece4e405620412);

        return $this->valueHolder5a9f3f1bece4a315313745->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 = $initializer;
    }
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, '__get', array('name' => $name), $this->initializer5a9f3f1bece4e405620412);

        if (isset(self::$publicProperties5a9f3f1bece3b267752283[$name])) {
            return $this->valueHolder5a9f3f1bece4a315313745->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a9f3f1bece4a315313745;
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a9f3f1bece4e405620412);
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, '__isset', array('name' => $name), $this->initializer5a9f3f1bece4e405620412);
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, '__unset', array('name' => $name), $this->initializer5a9f3f1bece4e405620412);
    ...
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, '__clone', array(), $this->initializer5a9f3f1bece4e405620412);

        $this->valueHolder5a9f3f1bece4a315313745 = clone $this->valueHolder5a9f3f1bece4a315313745;
    }

    public function __sleep()
    {
        $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, '__sleep', array(), $this->initializer5a9f3f1bece4e405620412);

        return array('valueHolder5a9f3f1bece4a315313745');
    }
    ...
    {
        return $this->initializer5a9f3f1bece4e405620412;
    }
    ...
    {
        return $this->initializer5a9f3f1bece4e405620412 && $this->initializer5a9f3f1bece4e405620412->__invoke($this->valueHolder5a9f3f1bece4a315313745, $this, 'initializeProxy', array(), $this->initializer5a9f3f1bece4e405620412);
    }
    ...
    {
        return null !== $this->valueHolder5a9f3f1bece4a315313745;
    }
    ...
    {
        return $this->valueHolder5a9f3f1bece4a315313745;
    }
